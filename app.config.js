...
export default {
  expo: {
    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSLocationWhenInUseUsageDescription:
          'This app needs access to your location to display maps and your current position.',
    ...
    android: {
      ...
      userInterfaceStyle: 'light',
      permissions: ['READ_EXTERNAL_STORAGE', 'CAMERA', 'ACCESS_FINE_LOCATION', 'ACCESS_COARSE_LOCATION', 'CAMERA_ROLL'],
      adaptiveIcon: {
